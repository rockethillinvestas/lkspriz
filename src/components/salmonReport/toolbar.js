  ...
  render () {
    return (
      <div className="toolbar">
        ...
        <p>Vis historie <input type="checkbox" checked={this.state.userInterface.tableVisible} name="tableVisible" onChange={this.handleClick} /></p>
        </div>
        <div className="graph">
        <p>Vis graf <input type="checkbox" checked={this.state.userInterface.graphVisible} name="graphVisible" onChange={this.handleClick} /></p>
        </div>
      </div>
    )
  }
